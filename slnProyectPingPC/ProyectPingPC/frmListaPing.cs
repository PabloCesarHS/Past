...
namespace ProyectPingPC
{
    public partial class frmListaPing : Form
    {
        ...
        public cResultado EjecutarPing(string _Direccion)
        {
        ...
        private void btnCorrerPrueba_Click(object sender, EventArgs e)
        {
        ...
        void EjecutarConsulta(int NroFila, string _Direccion)
        {
            var oResultado = EjecutarPing(_Direccion);
